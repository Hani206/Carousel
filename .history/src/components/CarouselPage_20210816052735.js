...
export default class CarouselPage extends Component {
    ...
    handleSlide = (selectedIndex, direction) => {
        ...
        console.log('handleSlide direction',direction);
       this.setState({index : selectedIndex});
       if(selectedIndex === 0 && this.state.pageCount > 1 && direction === 'end'){
           this.setState({pageCount : this.state.pageCount-1,index:0},()=>this.getItemsList());
       }else if(selectedIndex === 4 && direction === 'start'){
           this.setState({pageCount : this.state.pageCount+1,index:0},()=>this.getItemsList());
       }
    };

    // handleSlid = (selectedIndex, direction) => {
    //     console.log('handleSlid',selectedIndex);
    //     console.log('handleSlid direction',direction);
    //    this.setState({index : selectedIndex});
    //    if(selectedIndex === 0 && this.state.pageCount > 1 && direction === 'end'){
    //        this.setState({pageCount : this.state.pageCount-1,index:0},()=>this.getItemsList());
    //    }else if(selectedIndex === 4 && direction === 'start'){
